...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input_name", type=str, default="data/robosim_pairs.csv")
    parser.add_argument("-s", "--save_name", type=str, default="data/ri_instruction_program_pairs.csv")
